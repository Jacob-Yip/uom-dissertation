...
"""
Run: python -m src.utils.experiment.data_plotter_recursive_traditional
"""
...
CSV_PATH_RECURSIVE = os.path.join(
    ROOT_PATH, f"data", f"experiment", f"recursive", f"csv", f"experiment_runner_recursive_traditional.csv")
...
def mse_against_ensemble_size_8_16_fixed_architecture_6_fixed_epoch_num_400_fixed_aggregator_arithmetic_mean(raw_df_original_arithmetic_mean: pd.DataFrame, raw_df_original_median: pd.DataFrame, raw_df_original_nn: pd.DataFrame, raw_df_recursive: pd.DataFrame, img_repository_path: str):
    ...
    filter_original_arithmetic_mean = {
        ...
        "ensemble_size": [
            # Only interested in cases of ensemble_size = 4*n: ensemble_size = 8, ensemble_size = 12, ensemble_size = 16
            8,
            12,
            16
        ],
    ...
    IMG_RESOLUTION = 300
    IMG_NAME = f"recursive_traditional_mse_against_ensemble_size_8_16_fixed_architecture_6_fixed_epoch_num_400_fixed_aggregator_arithmetic_mean.png"
    # ====================================================================
    ...
    # X-axis
    data_x = np.array(df_original_arithmetic_mean["ensemble_size"].unique())
    ...
    axis.plot(data_x, mse_original, marker="o",
              label=f"Non-recursive arithmetic-mean-ensemble")
...
def mse_against_ensemble_size_8_16_fixed_architecture_6_fixed_epoch_num_400_fixed_aggregator_median(raw_df_original_arithmetic_mean: pd.DataFrame, raw_df_original_median: pd.DataFrame, raw_df_original_nn: pd.DataFrame, raw_df_recursive: pd.DataFrame, img_repository_path: str):
    ...
    X_AXIS = f"ensemble_size"
    Y_AXIS = f"MSE"
    FIGURE_TITLE = f"MSE vs ensemble_size\n(each base learner is [6] trained with 400 epochs)\n(an median-aggregator is used)"
    # Related to the saved image file in img/
    IMG_RESOLUTION = 300
    IMG_NAME = f"recursive_traditional_mse_against_ensemble_size_8_16_fixed_architecture_6_fixed_epoch_num_400_fixed_aggregator_median.png"
    # ====================================================================
    ...
    # X-axis
    data_x = np.array(df_original_median["ensemble_size"].unique())
...
def mse_against_ensemble_size_8_16_fixed_architecture_6_fixed_epoch_num_400_fixed_aggregator_nn(raw_df_original_arithmetic_mean: pd.DataFrame, raw_df_original_median: pd.DataFrame, raw_df_original_nn: pd.DataFrame, raw_df_recursive: pd.DataFrame, img_repository_path: str):
    ...
    X_AXIS = f"ensemble_size"
    Y_AXIS = f"MSE"
    FIGURE_TITLE = f"MSE vs ensemble_size\n(each base learner is [6] trained with 400 epochs)\n(an neural-network-aggregator is used)"
    # Related to the saved image file in img/
    IMG_RESOLUTION = 300
    IMG_NAME = f"recursive_traditional_mse_against_ensemble_size_8_16_fixed_architecture_6_fixed_epoch_num_400_fixed_aggregator_nn.png"
    # ====================================================================
    ...
    # X-axis
    data_x = np.array(df_original_nn["ensemble_size"].unique())
...
if __name__ == "__main__":
    ...
    mse_against_ensemble_size_8_16_fixed_architecture_6_fixed_epoch_num_400_fixed_aggregator_arithmetic_mean(
    ...
    mse_against_ensemble_size_8_16_fixed_architecture_6_fixed_epoch_num_400_fixed_aggregator_median(
        raw_df_original_arithmetic_mean=df_original_arithmetic_mean,
        raw_df_original_median=df_original_median,
        raw_df_original_nn=df_original_nn,
        raw_df_recursive=df_recursive,
    ...
    mse_against_ensemble_size_8_16_fixed_architecture_6_fixed_epoch_num_400_fixed_aggregator_nn(
        raw_df_original_arithmetic_mean=df_original_arithmetic_mean,
        raw_df_original_median=df_original_median,
        raw_df_original_nn=df_original_nn,
        raw_df_recursive=df_recursive,
    ...
    logger.log(f"Graphs of recursive traditional experiment are saved ...")
